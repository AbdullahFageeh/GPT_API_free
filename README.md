 <!-- Performance: Optimized image loading with decoding="async" for faster parallel rendering -->
<div align="center">
...
以下以1000x150分辨率的图片为例，计算图片占用Tokens数为425。
 <!-- Performance: Added loading="lazy" for off-screen images to save bandwidth -->
...
<a href="https://www.star-history.com/#chatanywhere/GPT_API_free&Date"><img src="https://api.star-history.com/svg?repos=chatanywhere/GPT_API_free&type=Date" alt="Star History Chart" decoding="async" loading="lazy"/></a>
